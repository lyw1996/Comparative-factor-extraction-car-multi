...
def extraction():
	f1 = open('F:\Comparative-factor-extraction-car-multi\CRF++\outputT3.txt', 'r')
	f2 = open('F:\Comparative-factor-extraction-car-multi\CRF++\\test_answer.txt', 'r')
	f3 = open('F:\Comparative-factor-extraction-car-multi\CRF++\evaluateT3.txt', 'w')
	'''
	# 测试结果和答案是一样长的文件
	num = 0
	list2 = []
...
f4=open('F:\Comparative-factor-extraction-car-multi\CRF++\\result2T3.txt', 'w')
f5=open('F:\Comparative-factor-extraction-car-multi\CRF++\\result1T3.txt', 'w')
list=extraction()
