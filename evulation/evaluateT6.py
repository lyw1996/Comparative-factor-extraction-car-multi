...
def extraction():
	f1 = open('F:\Comparative-factor-extraction-car-multi\CRF++\outputT6.txt', 'r')
	f2 = open('F:\Comparative-factor-extraction-car-multi\CRF++\\test_answer.txt', 'r')
	f3 = open('F:\Comparative-factor-extraction-car-multi\CRF++\evaluateT6.txt', 'w')
...
f4=open('F:\Comparative-factor-extraction-car-multi\CRF++\\result2T6.txt', 'w')
f5=open('F:\Comparative-factor-extraction-car-multi\CRF++\\result1T6.txt', 'w')
list=extraction()
list2=[]
...
def evaluation(target1):
	list_stan = pre.result_data('..\data\多重比较汽车训练任务2.2改进.txt')
