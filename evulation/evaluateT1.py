...
import Defi_class
def extraction():
	f1 = open('F:\Comparative-factor-extraction-car-multi\CRF++\outputT1.txt', 'r')
	f2 = open('F:\Comparative-factor-extraction-car-multi\CRF++\\test_answer.txt', 'r')
	f3 = open('F:\Comparative-factor-extraction-car-multi\CRF++\evaluateT1.txt', 'w')
	'''
	#测试结果和答案是一样长的文件
	num=0
	list2=[]
...
f4=open('F:\Comparative-factor-extraction-car-multi\CRF++\\result2T1.txt', 'w')
f5=open('F:\Comparative-factor-extraction-car-multi\CRF++\\result1T1.txt', 'w')
list=extraction()
#print(len(list))
list3=[]
