...
def extraction():
	f1 = open('F:\Comparative-factor-extraction-car-multi\CRF++\outputT2.txt', 'r')
	f2 = open('F:\Comparative-factor-extraction-car-multi\CRF++\\test_answer.txt', 'r')
	f3 = open('F:\Comparative-factor-extraction-car-multi\CRF++\evaluateT2.txt', 'w')
	'''
	# 测试结果和答案是一样长的文件
	num = 0
	list2 = []
	...
	for line2 in f2.readlines():
		...
		if line2 == '\n':
			...
			f3.write('\n')
	return list
f4=open('F:\Comparative-factor-extraction-car-multi\CRF++\\result2T2.txt', 'w')
f5=open('F:\Comparative-factor-extraction-car-multi\CRF++\\result1T2.txt', 'w')
